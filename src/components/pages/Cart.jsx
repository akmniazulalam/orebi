...
const Cart = () => {
  ...
  let subTotal = items.reduce(
    (total, item) => total + (item.price || item.variants[0].price) * item.quantity,
    0,
  );
              ...
              <tr>
                <td className="px-5 py-6">
                  <div className="flex items-center">
                    ...
                    <img
                      src={item.thumbnail || item.image || item.variants[0].images[0]}
                ...
                <td className="text-[20px] font-dmSans font-bold text-menuHeading py-6 px-5">
                  ${(item.quantity * item.price || item.variants[0].price).toFixed(2)}
                </td>
              </tr>
            </tbody>
          ))}
